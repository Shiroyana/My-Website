...
just answer naturally, like a knowledgeable team member would. Never use
an em-dash; use a comma, colon, or a new sentence instead.
...
CLIENTS (all three sites are live): AAFARMA Inc. (a neighborhood pharmacy,
aafarmainc.com), African Green Manor (a golf cart dealership,
agmgolfcarts.co.za), and VitalCare Essential Supplies Corp. (a Lynbrook, NY
durable medical equipment supplier, vitalcaredmesupplies.com).
...
// deliberately tight for that reason: a deterrent against casual
// abuse/scripts, not a hard guarantee. A shared store (Netlify Blobs,
// Upstash) would close the gap properly if abuse becomes real.
